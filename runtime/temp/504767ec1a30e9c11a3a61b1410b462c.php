<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:62:"/mnt/code/tp5/public/../application/admin/view/tags/index.html";i:1522223174;s:53:"/mnt/code/tp5/application/admin/view/pages/index.html";i:1522222387;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
<div class="row">
    <div class="col-lg-12">
        <div class="panel panel-default">
                        ...
                        <td>
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu" role="menu">
                                    <li><a href="edit?id=<?php echo $tag['tag_id']; ?>" type="button">修改</a>
                                    </li>
                                    <li><a href="delete?id=<?php echo $tag['tag_id']; ?> type="button">删除</a>
                                    </li>
                                </ul>
                            </div>
                        </td>
            ...
            <!-- /.panel-body -->
            <div style="float:right" class="dataTables_paginate paging_simple_numbers" id="dataTables-example_paginate"><?php echo $page; ?></div>
        </div>
        <!-- /.panel -->
    </div>
    <!-- /.col-lg-12 -->
