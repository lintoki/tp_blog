<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:64:"/mnt/code/tp5/public/../application/admin/view/category/add.html";i:1521098924;s:53:"/mnt/code/tp5/application/admin/view/pages/index.html";i:1522046887;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
<form method="post" action="store" role="form">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" name="cate_sort">
    </div>
