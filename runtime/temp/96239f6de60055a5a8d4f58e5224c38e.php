<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:66:"/mnt/code/tp5/public/../application/admin/view/category/index.html";i:1522251697;s:53:"/mnt/code/tp5/application/admin/view/pages/index.html";i:1522222387;}*/ ?>
<!DOCTYPE html>
<html lang="en">
            ...
            <div class="panel-body">
                <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                    ...
                    <tr class="odd gradeX">
                        ...
                        <td><?php echo $cate['_cate_name']; ?></td>
                        <td>
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu" role="menu">
                                    <li><a href="edit?id=<?php echo $cate['cate_id']; ?>" type="button">修改</a>
                                    </li>
                                    <li><a href="addson?id=<?php echo $cate['cate_id']; ?>" type="button">添加子集</a>
                                    </li>
                                    <li><a href="delete?id=<?php echo $cate['cate_id']; ?>&pid=<?php echo $cate['cate_pid']; ?>" type="button">删除</a>
                                    </li>
                                </ul>
                            </div>
                        </td>
