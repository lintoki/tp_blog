<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:63:"/mnt/code/tp5/public/../application/admin/view/article/add.html";i:1522223754;s:53:"/mnt/code/tp5/application/admin/view/pages/index.html";i:1522222387;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
<form method="post" action="store" role="form">
    ...
    <div class="form-group">
        <label>作者</label>
        <input class="form-control" placeholder="作者">
    </div>
    <div class="form-group">
        <label>分类</label>
    ...
    <div class="form-group">
        ...
        <div class="checkbox">
            <label>
                <input type="checkbox" value="">标签 1
            </label>
        </div>
        <div class="checkbox">
            <label>
                <input type="checkbox" value="">标签 2
            </label>
        </div>
    </div>
    <div class="form-group">
